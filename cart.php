                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="fw-bold"><?php echo htmlspecialchars($movie['movie_name']); ?></td>
                                            <td class="text-end text-success fw-bold"><?php echo number_format($movie['movie_price'], 0); ?> ฿</td>
                                            <td class="text-center">
                                                <a href="remove_from_cart.php?id=<?php echo urlencode($movie_ID); ?>" class="btn btn-sm btn-danger">
                                ...
                                <tfoot class="table-dark">
                                    <tr>
                                        ...
                                        <th class="text-end text-success fw-bold"><?php echo number_format($total, 0); ?> ฿</th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
